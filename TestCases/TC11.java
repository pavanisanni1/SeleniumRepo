...
public class TC11 {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.id("fname")).sendKeys("Recently Added New View7");
        driver.findElement(By.id("devname")).sendKeys("RANV7");
        driver.findElement(By.xpath("//input[@data-uidsfdc=\"3\"]")).click();
        
        WebElement viewOptions=driver.findElement(By.xpath("//select[@title='View:']"));
        Select view=new Select(viewOptions);
        String str=view.getFirstSelectedOption().getText();
       // System.out.println(str);
        
        if(str.equals("Recently Added New View7"))
        	System.out.println("pass"+ str+" is present");
	}
